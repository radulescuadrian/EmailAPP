...
<head>
    ...
    <title>Proiect EAP - Prieteni</title>
    <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
    <link href="https://fonts.googleapis.com/css?family=Sen&display=swap" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="/Dashboard/prieteni/prieteni.css">
</head>
<body class="home">
<%
        ...
        <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
            ...
            <div class="navi">
                <ul>
                    ...
                    <li class="active"><a href="#"><i class="fa fa-users" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Prieteni</span></a></li>
                    <li><a href="../rapoarte"><i class="fa fa-flag" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Rapoarte</span></a></li>
                </ul>
            </div>
        </div>
        <div class="col-md-10 col-sm-11 display-table-cell v-align">
            ...
            <div class="user-dashboard">
                ...
                <div class="row" style="padding-top: 15px;">
                    <div class="col-md-4 col-sm-6 col-xs-12 gutter" style="float: right;">
                        <div class="friends">
                            <h3>USERI</h3>
                            <hr>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $.post('/getUsers', {username}, function (data) {
            $('#users').html(data);
        });
    });
    //get friend request
    $(document).ready(function () {
        $.post('/getFR', {username}, function (data) {
            $('#fr').html(data);
        });
    });
    let friend = "";
    //show request sent + run query
    $(function () {
        $(document).on("click","#users tr .BUTON",function() {
            let tr = $(this).closest('tr');
            friend = tr.find('td p').text();
            $.post('/runFR',{username,friend});
        });
    });
    //accept
    let fraccept = "";
    $(function () {
        $(document).on("click", "#fr tr .BUTONACC", function () {
            let trow = $(this).closest('tr');
            fraccept = trow.find('td p').text();
            $.post('/accept',{username,fraccept});
        });
    });
    //get friends list
    $(document).ready(function () {
        $.post('/getFriends', {username}, function (data) {
            $('#friend').html(data);
        });
    });
</script>
