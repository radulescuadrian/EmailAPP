...
<head>
    ...
    <title>Proiect EAP - Mailuri</title>
    <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
    <link href="https://fonts.googleapis.com/css?family=Sen&display=swap" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="/Dashboard/mailuri/mailuri.css">
</head>
<body class="home">
<%
...
<div class="container-fluid display-table">
    <div class="row display-table-row">
        <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
            ...
            <div class="navi">
                <ul>
                    <li class="active"><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Mail-uri</span></a></li>
                                    ...
                                    <ul class="dropdown-menu" style="width: 191px; left: -100px;">
                                        <li>
                                            <div class="navbar-content">
                                                ...
                                                <p class="text-muted small"><%out.print(session.getAttribute("user"));%>@testMail.com</p>
                                            </div>
                                        </li>
                                    </ul>
                                </li>
